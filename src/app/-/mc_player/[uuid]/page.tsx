...
export default function Page({ params: paramsPromise }: { params: Promise<{ uuid: string }> }) {
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <Card className="bg-[#3B8526] border-none">
                              <div className="text-center p-3">
                                ...
                                <div className="text-sm text-[#E0E0E0]">累计成就</div>
                              </div>
                            </Card>
                            <Card className="bg-[#3B8526] border-none">
                              <div className="text-center p-3">
                                ...
                                <div className="text-sm text-[#E0E0E0]">成就点数</div>
                              </div>
                            </Card>
                          </div>
                        </div>
                          ...
                          <div className="space-y-3">
                            <Card className="bg-[#3B8526] border-none">
                              <div className="flex items-center justify-between p-3">
                                <span className="text-[#E0E0E0]">用户类型</span>
